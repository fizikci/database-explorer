...
export function activate(context: vscode.ExtensionContext) {
    context.subscriptions.push(
        vscode.commands.registerCommand('database-explorer.start', () => {
...
function getWebviewContent(extensionPath: string, webview: vscode.Webview): string {
    ...
    const angularFilterUri = webview.asWebviewUri(
        vscode.Uri.file(path.join(extensionPath, 'media', 'angular-filter.min.js'))
    );
    ...
    .replace('ANGULAR_FILTER_URI', angularFilterUri.toString());
}
